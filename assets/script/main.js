    ...
    foodCard.innerHTML = `
         <div onclick= "loadFoodDetails(${food.id})" class="p-5 bg-white flex gap-3 shadow rounded-xl">
            ...
            <div class="flex-2">
              ...
              <div class="badge mt-2 badge-warning">${food.category} </div>
...
const displayModal = (food) => {
  ...
  detailsContainer.innerHTML = `
        ...
        <div>
          <img class="mt-2" src="${food.foodImg}" alt="">
        </div>
        <div class= "badge badge-primary">
        ${food.area}
        </div>
        <a href="${food.video}" target="_blank" class="btn btn-warning mt-3">Watch video</a>
          `;
